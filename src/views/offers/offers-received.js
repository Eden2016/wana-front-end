    ...
    return (
      <div className="sent-offers sittings-content">
        <ul className="sittings-list">
          ...
          { completedOffers.length > 0 && <h3>Completed Offers You Received</h3> }
          { completedOffers.length > 0 && completedOffersMarkup }

          { acceptedOffers.length > 0 && <h3>Accepted Offers You Received</h3> }
          { acceptedOffers.length > 0 && acceptedOffersMarkup }

          { pendingOffers.length > 0 && <h3>Pending Offers You Received</h3>}
          { pendingOffers.length > 0 && pendingOffersMarkup }

          { declinedOffers.length > 0 && <h3>Declined Offers You Received</h3> }
          { declinedOffers.length > 0 && declinedOffersMarkup }

          { canceledOffers.length > 0 && <h3>Canceled Offers You Received</h3> }
